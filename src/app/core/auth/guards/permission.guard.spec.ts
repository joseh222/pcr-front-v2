...
describe('permissionGuard', () => {
    ...
    it('should redirect to dashboard when permission is missing', () => { const tree = {} as UrlTree; routerMock.createUrlTree.mockReturnValue(tree); expect(execute([PERMISSION_CODE.ROLE_VIEW])).toBe(tree); expect(routerMock.createUrlTree).toHaveBeenCalledWith(['/dashboard']); });
