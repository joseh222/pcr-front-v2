...
describe('SolicitudServicioDetailPage', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({ imports: [SolicitudServicioDetailPage], providers: [provideRouter([]), { provide: ActivatedRoute, useValue: { snapshot: { paramMap: convertToParamMap({ id: '10' }) } } }, { provide: SolicitudServicioCancellationService, useValue: cancellationMock }] });
