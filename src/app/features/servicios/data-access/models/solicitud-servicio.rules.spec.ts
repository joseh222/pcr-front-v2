...
describe('solicitud-servicio rules', () => {
    it('should keep Misa under its own domain', () => {
        const item = { codigoServicio: 'MISA', estadoSolicitud: 'ACTIVA', estadoPago: 'PENDIENTE', requierePago: true, puedeCobrar: true } as any;
    ...
    it('should allow generic pending request operations', () => {
        const item = { codigoServicio: 'CONSTANCIA', estadoSolicitud: 'ACTIVA', estadoPago: 'PENDIENTE', requierePago: true, puedeCobrar: true } as any;
    ...
    it('should block commercial changes after payment', () => {
        const item = { codigoServicio: 'CONSTANCIA', estadoSolicitud: 'ACTIVA', estadoPago: 'PAGADO', requierePago: true, puedeCobrar: true } as any;
