...
import { CatalogoEstadoRequest, CatalogoPredeterminadoRequest, ConfiguracionParroquia, ConfiguracionParroquiaUpdateRequest, MantenimientoWriteResponse, MetodoPagoCreateRequest, MetodoPagoMantenimiento, MetodoPagoUpdateRequest, TipoComprobanteCreateRequest, TipoComprobanteMantenimiento, TipoComprobanteUpdateRequest, SerieComprobanteMantenimiento, SerieComprobanteCreateRequest, SerieComprobanteInicioUpdateRequest, SerieComprobanteDefaultRequest, MisaPrecioOpcion, MisaPrecioMantenimiento, MisaPrecioCreateRequest, MisaPrecioDesactivarRequest, CatalogoConfiguracionMantenimiento, CatalogoConfiguracionCreateRequest, CatalogoConfiguracionUpdateRequest, TipoComprobanteCompraMantenimiento, TipoComprobanteCompraCreateRequest, TipoComprobanteCompraUpdateRequest } from './models/configuracion-mantenimientos.models';
...
export class ConfiguracionApiService {
    ...
    setMetodoPagoPredeterminado(id: number, request: CatalogoPredeterminadoRequest): Observable<MantenimientoWriteResponse> { return this.http.patch<MantenimientoWriteResponse>(`${this.url}/configuracion/metodos-pago/${id}/predeterminado`, request); }
    ...
    setTipoComprobantePredeterminado(id: number, request: CatalogoPredeterminadoRequest): Observable<MantenimientoWriteResponse> { return this.http.patch<MantenimientoWriteResponse>(`${this.url}/configuracion/tipos-comprobante/${id}/predeterminado`, request); }
    getTiposComprobanteCompra(): Observable<readonly TipoComprobanteCompraMantenimiento[]> { return this.http.get<readonly TipoComprobanteCompraMantenimiento[]>(`${this.url}/configuracion/tipos-comprobante-compra`); }
    createTipoComprobanteCompra(request: TipoComprobanteCompraCreateRequest): Observable<MantenimientoWriteResponse> { return this.http.post<MantenimientoWriteResponse>(`${this.url}/configuracion/tipos-comprobante-compra`, request); }
    updateTipoComprobanteCompra(id: number, request: TipoComprobanteCompraUpdateRequest): Observable<MantenimientoWriteResponse> { return this.http.put<MantenimientoWriteResponse>(`${this.url}/configuracion/tipos-comprobante-compra/${id}`, request); }
    changeTipoComprobanteCompraStatus(id: number, request: CatalogoEstadoRequest): Observable<MantenimientoWriteResponse> { return this.http.patch<MantenimientoWriteResponse>(`${this.url}/configuracion/tipos-comprobante-compra/${id}/estado`, request); }
    setTipoComprobanteCompraPredeterminado(id: number, request: CatalogoPredeterminadoRequest): Observable<MantenimientoWriteResponse> { return this.http.patch<MantenimientoWriteResponse>(`${this.url}/configuracion/tipos-comprobante-compra/${id}/predeterminado`, request); }
