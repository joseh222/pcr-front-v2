...
const CONSTANCIA_PRINTER = { modo: 'MANUAL', tipoConexion: 'USB', nombreImpresoraWindows: 'HP CONSTANCIAS', direccionIp: null, puerto: null, estaConfigurada: true, updatedUtc: null, updatedBy: null, rowVersion: 'PPPP' } as const;
...
describe('ConfiguracionImpresionPage', () => {
    ...
    const constanciaApi = {
        getConfiguracion: vi.fn(() => of(CONSTANCIA_CONFIG)),
        updateConfiguracion: vi.fn(() => of(CONSTANCIA_CONFIG)),
        getImpresora: vi.fn(() => of(CONSTANCIA_PRINTER)),
        updateImpresora: vi.fn(() => of({ configuracion: CONSTANCIA_PRINTER, plantillasDescalibradas: 0, mensaje: 'OK' })),
        validarImpresora: vi.fn(() => of({ disponible: true, impresora: 'HP CONSTANCIAS', agente: 'PCR-PRINT-01', equipo: 'PREPROD', ultimoContactoUtc: null, mensaje: 'OK' })),
        ...
        imprimirPrueba: vi.fn(() => of({ idTrabajo: 1, tipoDocumento: 'CONSTANCIA_PRUEBA', estado: 'PENDIENTE', impresora: 'HP CONSTANCIAS', cantidadCopias: 1, codigo: 'QUEUED', mensaje: 'OK' })),
        getTrabajoEstado: vi.fn(() => of({ idTrabajo: 1, tipoDocumento: 'CONSTANCIA_PRUEBA', entidadOrigen: 'CONSTANCIA_PLANTILLA', idOrigen: 1, codigoReferencia: 'BAUTISMO', numeroSolicitud: 1, modoImpresion: 'MANUAL', impresora: 'HP CONSTANCIAS', estado: 'COMPLETADO', intentos: 1, maxIntentos: 3, cantidadCopias: 1, fechaCreacionUtc: '', fechaActualizacionUtc: '', fechaFinalizacionUtc: '', ultimoDetalle: null, rowVersion: 'RRRR' }))
    };
